...
export const els = {
    keyInput: $('#key-input'),
    eyeBtn: $('#eye-btn'),
    eyePath: document.querySelector('#eye-path'),
    detectedBadge: $('#detected-badge'),
    detectedLabel: $('#detected-label'),
    providerTabs: document.querySelectorAll('.ptab'),
...
const EYE_SHUT = 'M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24 M1 1l22 22';
...
export function activateProviderTab(id) {
...
export function updateKeyMeta(val) {
    if (val.length > 0) {
...
export function showDetectedBadge(label) {
    if (label) {
